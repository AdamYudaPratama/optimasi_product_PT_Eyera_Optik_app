...
st.markdown("**Contoh Industri: PT Eyera Optik - Kacamata Wayfare, Kacamata Aviator, dan Kacamata Minus**")
...
PRODUCTS = {
    "Kacamata Wayfare": {
        "bahan_baku": {"Kulit Sintetis": 0.8, "Sol Karet": 0.15, "Benang": 0.05},
        "harga_jual": 250000,
        "biaya_produksi": 180000,
        "waktu_produksi": 5/60  # 5 menit = 0.083 jam
    },
    "Kacamata Aviator": {
        "bahan_baku": {"Kulit Sintetis": 0.7, "Sol Karet": 0.2, "Benang": 0.1},
        "harga_jual": 200000,
        "biaya_produksi": 150000,
        "waktu_produksi": 6/60  # 6 menit = 0.1 jam
    },
    "Kacamata Minus": {
        "bahan_baku": {"Kulit Asli": 0.9, "Sol Karet": 0.08, "Benang": 0.02},
        "harga_jual": 180000,
        "biaya_produksi": 145000,
        "waktu_produksi": 9/60  # 9 menit = 0.15 jam
    }
}


BAHAN_BAKU = {
    "Kulit Sintetis": {"harga": 50000, "lead_time": 7, "holding_cost": 0.15},
    "Kulit Asli": {"harga": 100000, "lead_time": 10, "holding_cost": 0.20},
    "Sol Karet": {"harga": 20000, "lead_time": 5, "holding_cost": 0.12},
    "Benang": {"harga": 5000, "lead_time": 3, "holding_cost": 0.08}
}
